function [MaxThrust,SolidRocketThrust, MainEngineThrust] = Thrust(pressure,jettison,Throttle,n,timestep)
% Thrust(pressure,jettison,Throttle,n,timestep)
...
if (n <= 519/timestep) %zero thrust, main engine cutoff at this point
